 ...
 * </pre>
 *
 * @version $Revision: 1.2 $, $Date: 2003/01/31 16:53:28 $
 * @author bill
...
public class MonitorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equals(ACTION_CHART)) {
            throw new ServletException("Unsuported in JDK 1.2 code");
        } else {
    ...
    private void doSnapshot(ServletOutputStream out, String alias, String link, String level) throws IOException, ProxoolException {
        ...
        connectionsBuffer.append("\">max</font>)");
...
/*
 ...
 Revision 1.2  2003/01/31 16:53:28  billhorsman
 checkstyle
